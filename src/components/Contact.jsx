...
//         e.preventDefault();
//         // Add form submission logic here (e.g., using a backend API or a service like Formspree)
//         window.location.href = `mailto:your-email@example.com?subject=Message from ${formData.fullname}&body=${formData.message} (${formData.email})`;
//     };

//     return (
//         <div name="Contact" className="bg-black text-white min-h-screen flex flex-col items-center justify-center px-12 py-12">
//             <h2 className="text-4xl font-semibold text-center mb-8">Get in touch with me!</h2>
//             <div className='text-center mb-3'>
//                 <p className="text-center justify-centre text-lg mb-2 mx-5">
...
//                 <a href="mailto:venkatashiva1104@gmail.com" className="text-white text-lg hover:scale-105 transition-transform">
